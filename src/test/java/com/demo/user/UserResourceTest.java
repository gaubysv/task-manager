...
class UserResourceTest {
    ...
    void delete() throws Throwable {
        ...
        User user = VertxContextSupport.subscribeAndAwait(() -> Panache.withSession(() -> User.findById(toDelete.id)));
    ...
    void changePassword() throws Throwable {
        ...
        User user = VertxContextSupport.subscribeAndAwait(() -> Panache.withSession(() -> User.findById(0L)));

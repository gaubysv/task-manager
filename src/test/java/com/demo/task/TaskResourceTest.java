...
class TaskResourceTest {
    ...
    void updateForbidden() throws Throwable {
        ...
        task.user = admin;
        Task adminTask = VertxContextSupport.subscribeAndAwait(() -> Panache.withSession(() -> task.persistAndFlush()));
        given()
                .body("{\"title\":\"to-update\"}")
                .contentType(ContentType.JSON)
    ...
    void delete() throws Throwable {
        ...
        given()
                ...
                .then()
                .statusCode(204);
        Task task = VertxContextSupport.subscribeAndAwait(() -> Panache.withSession(() -> Task.findById(toDelete.id)));
    ...
    void setComplete() throws Throwable {
        ...
        given()
                ...
                .then()
                .statusCode(200);
        Task task = VertxContextSupport.subscribeAndAwait(() -> Panache.withSession(() -> Task.findById(toSetComplete.id)));
        assertThat(task,
                allOf(
